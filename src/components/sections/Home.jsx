            ...
            <RevealOnScroll>
                <div className="text-center z-10 px-4">
                    ...
                    <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
                        I'm a full-stack developer who loves crafting clean, scalable applications. With a focus on Spring Boot for robust backends, and intuitive UI design for web and mobile, I aim to build seamless, high-performance user experiences.                
                    </p>
